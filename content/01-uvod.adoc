...
Gobo Eiffel—koristi manje striktnu, MIT licencu, pa se može koristiti i za
komercijalni vlasnički softver. Cilj projekta je praćenje ISO standarda u što
većoj meri.
...
integrisanih u jedan korisnički interfejs. Dostupan u GPL i komercijalnoj
licenci.
...
obliku tar arhive, a zatim kompajlirati na bilo kojem Linux
